...
const solution_interactive_display_jpg_1 = __importDefault(
  require("@/assets/solution-interactive-display.jpg"),
);
const solution_projector_jpg_1 = __importDefault(require("@/assets/solution-projector.jpg"));
const solution_wireless_presentation_jpg_1 = __importDefault(
  require("@/assets/solution-wireless-presentation.jpg"),
);
