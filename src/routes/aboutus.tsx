...
const stats = [
  { v: "20+", l: "ปีประสบการณ์" },
  { v: "500+", l: "โปรเจ็คที่สำเร็จ" },
  { v: "8+", l: "แบรนด์ระดับโลก" },
  { v: "100%", l: "บริการในประเทศ" },
];

const partners = [
  { name: "Kramer", img: partnerKramer, tag: "อุปกรณ์ระบบ AV ที่ของมันต้องมี" },
  { name: "Grandview", img: partnerGrandview, tag: "จอรับภาพ คุณภาพเหนือราคา" },
  { name: "Newline", img: partnerNewline, tag: "จอทัชสกรีนอัจฉริยะ คุณภาพสูง" },
  { name: "Yealink", img: partnerYealink, tag: "ชุดประชุมคุณภาพ ราคาประหยัด" },
  { name: "Vissonic", img: partnerVissonic, tag: "ระบบประชุมระดับมืออาชีพ" },
  { name: "Poly", img: partnerPoly, tag: "รวมอุปกรณ์ชุดประชุมคุณภาพ" },
  { name: "AVLink", img: partnerAvlink, tag: "The Highest Quality AV Solutions" },
  { name: "Enewave", img: partnerEnewave, tag: "Enewave ครบเครื่องเรื่องเสียง" },
];
...
function AboutPage() {
  return (
    <>
      <PageHeader
        eyebrow="About Us"
        title="เกี่ยวกับบริษัท Matrix Intertrade"
        desc="ผู้นำเข้าและจัดจำหน่ายระบบภาพแบรนด์ชั้นนำของโลก ด้วยประสบการณ์ทีมงานมากกว่า 20 ปี คัดสรรเฉพาะผลิตภัณฑ์คุณภาพสูงที่เชื่อถือได้ระดับแนวหน้าของโลก"
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight">
              เกี่ยวกับบริษัท Matrix Intertrade
            </h2>
            <div className="mt-5 space-y-4 text-muted-foreground leading-relaxed">
              <p>
                <strong className="text-foreground">บริษัท แมทริกซ์ อินเตอร์เทรด จำกัด</strong>{" "}
                เป็นผู้จัดจำหน่ายผลิตภัณฑ์ที่ใช้ในสำนักงานเพื่อเสริมประสิทธิภาพของการทำงานในหลากหลายรูปแบบ
                อาทิ จอรับภาพโปรเจคเตอร์ขนาดต่าง ๆ, จอ LED, กระดานอัจฉริยะ, อุปกรณ์ต่อเชื่อมระบบภาพ
                และการแสดงผลระบบภาพที่ทันสมัย ตอบโจทย์ยุคดิจิตอลทุกความต้องการ
              </p>
              <p>
                ด้วยวิสัยทัศน์ที่เล็งเห็นว่า
                เครื่องมือและอุปกรณ์สำนักงานที่ดีและมีเสถียรภาพสูงเท่านั้น
                ที่จะตอบโจทย์การลงทุนที่คุ้มค่า
                และจะเพิ่มประสิทธิภาพการทำงานขององค์กรในโลกเทคโนโลยียุคปัจจุบันได้อย่างแท้จริง
              </p>
              <p>
                ผลิตภัณฑ์คุณภาพต่ำที่ดูเหมือนจะประหยัดในตอนต้น
                แต่กลับสร้างปัญหาในการใช้งานและบั่นทอนประสิทธิภาพในการทำงาน
                จากประสบการณ์อันยาวนานมากกว่า <strong className="text-foreground">20 ปี</strong>{" "}
                ของทีมงานเมทริกซ์ฯ ผลิตภัณฑ์ที่เราคัดสรรมาบริการท่าน ล้วนเป็นผลิตภัณฑ์ที่มีคุณภาพสูง
                เป็นที่เชื่อถือระดับแนวหน้าของโลกทั้งสิ้น
              </p>
            </div>
            ...
            {[
              {
                Icon: Target,
                t: "Mission",
                d: "ส่งมอบโซลูชั่นภาพและเสียงที่ตอบโจทย์การใช้งานจริงและคุ้มค่าระยะยาวให้กับทุกองค์กร",
              },
              {
                Icon: Eye,
                t: "Vision",
                d: "เป็นพาร์ทเนอร์อันดับหนึ่งด้านระบบภาพของไทย ที่องค์กรชั้นนำไว้วางใจเลือกใช้",
              },
              {
                Icon: Heart,
                t: "Values",
                d: "ความซื่อสัตย์ ความเชี่ยวชาญ และการดูแลลูกค้าตลอดอายุการใช้งานของผลิตภัณฑ์",
              },
            ].map(({ Icon, t, d }) => (
              <div key={t} className="rounded-2xl border border-border bg-card p-7 shadow-card">
                ...
                <h3 className="text-xl font-bold text-primary mb-2">{t}</h3>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight">
              ผลิตภัณฑ์ตามกลุ่มลูกค้าและการใช้งาน
            </h2>
            <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
              เราคัดสรรอุปกรณ์ระบบภาพและเสียงให้เหมาะกับการใช้งานเฉพาะของแต่ละกลุ่มองค์กร
              พร้อมทีมผู้เชี่ยวชาญดูแลตลอดอายุการใช้งาน
            </p>
          </div>

          <div className="grid gap-6 md:grid-cols-2">
            {industries.map(({ Icon, title, subtitle, desc, img, href }) => (
              <Link
                key={title}
                to={href}
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight">
              แบรนด์ชั้นนำที่เราเป็นตัวแทนจำหน่าย
            </h2>
            <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
              คัดสรรเฉพาะแบรนด์ที่ได้รับการยอมรับระดับโลก
              พร้อมการรับประกันและบริการหลังการขายในประเทศ
            </p>
          </div>
            ...
            {partners.map((p) => (
              ...
              >
                <div className="aspect-square grid place-items-center bg-white rounded-xl overflow-hidden p-3 mb-3">
                  <img
                    src={p.img}
                    alt={`${p.name} — ${p.tag} partner brand of Matrix Intertrade`}
                    loading="lazy"
                    className="h-full w-full object-contain transition-transform duration-500 group-hover:scale-105"
                  />
                </div>
                <div className="font-bold text-primary text-sm">{p.name}</div>
                <div className="text-[11px] text-muted-foreground mt-1 leading-snug">{p.tag}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-gradient-subtle py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-6 grid lg:grid-cols-[1.2fr_1fr] gap-10">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight">
              บริษัท แมทริกซ์ อินเตอร์เทรด จำกัด
            </h2>
            <p className="mt-4 text-muted-foreground">
              สำนักงานและคลังสินค้าตั้งอยู่ที่นนทบุรี
              พร้อมทีมงานเทคนิคและฝ่ายขายที่พร้อมให้บริการลูกค้าทั่วประเทศ
            </p>
              ...
              {[
                {
                  Icon: MapPin,
                  t: "ที่อยู่",
                  d: "111/51 หมู่ที่ 8 ตำบลบางกร่าง อ.เมือง จ.นนทบุรี 11000 ประเทศไทย",
                },
                { Icon: Phone, t: "โทรศัพท์", d: "02-129-6193 / 092-932-8649" },
                { Icon: Mail, t: "อีเมล", d: "matrixintertrade2026@gmail.com" },
                { Icon: Globe, t: "เว็บไซต์", d: "www.matrixintertrade.com" },
            ...
            <div className="mt-6 flex gap-3">
              ...
              <Button asChild variant="outline">
                <Link to="/brands">ดูแบรนด์ทั้งหมด</Link>
              </Button>
            </div>
          </div>
