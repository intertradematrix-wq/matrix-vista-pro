...
const brandAccent = {
  unilumin: { from: "#0ea5e9", to: "#2563eb" },
  // sky → blue
  kramerav: { from: "#1e3a8a", to: "#4f46e5" },
  // navy → indigo
  grandview: { from: "#64748b", to: "#0f172a" },
  // slate → near-black
  persona: { from: "#06b6d4", to: "#0d9488" },
  // cyan → teal
  transcreen: { from: "#38bdf8", to: "#2563eb" }
  // sky → blue
};
export {
  brandLogos as a,
