...
content = content.replace(/to=\{\`\/industry\/\$\{i\.slug\}\`\}/g, 'to="/industry/$slug" params={{ slug: i.slug }}');
content = content.replace(/to=\{\`\/industry\/\$\{slug\}\`\}/g, 'to="/industry/$slug" params={{ slug }}');
